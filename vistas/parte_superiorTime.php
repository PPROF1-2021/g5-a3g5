...
<head>
    ...
    <meta http-equiv="Refresh" content="4;url=contenido.php">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3"><img class="logo" src="img/logo.png" width="124" height="105" alt="logo sin imagen"></div>
            </a>
            ...
            <!-- Nav Item - Cliente -->
            <li class="nav-item">
                <a class="nav-link" href="tablaCliente.php">
            ...
            <!-- Nav Item - Usuario -->
            <li class="nav-item">
                <a class="nav-link" href="tablaUsuario.php">
            ...
            <div class="sidebar-card d-none d-lg-flex">
              ...
              <p class="text-center mb-2"><strong>Tutorial</strong></p>
                <a class="btn btn-success btn-sm" href="https://startbootstrap.com/theme/sb-admin-pro"><i class="fab fa-youtube"></i>  ver</a>
            </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $usuario2?></span>
